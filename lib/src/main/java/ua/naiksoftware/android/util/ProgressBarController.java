...
public class ProgressBarController {
     ...
     */
    public static void showProgressDialog(final Context context, @Nullable final String message) {
     ...
     * @param message the message to show in a dialog
     */
    public static void showProgressDialog(final Context context, @Nullable String tag, @Nullable final String message) {
